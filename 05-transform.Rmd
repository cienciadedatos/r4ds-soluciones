...
Podemos identificar estos vuelos a través de la variable `tiempo_vuelo`. Aquellos que estuvieron viajando más tiempo fueron:
```{r}
arrange(vuelos, desc(tiempo_vuelo))
```

Los que viajaron menos tiempo:
